...
class PCRastersqrtAlgorithm(QgsProcessingAlgorithm):
    """
    ...
    def shortHelpString(self):
        ...
        return self.tr(
            ...
            <a href="https://pcraster.geo.uu.nl/pcraster/4.3.0/documentation/pcraster_manual/sphinx/op_sqrt.html">PCRaster documentation</a>
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        sqrtLayer = sqrt(InputRaster)
        outputFilePath = self.parameterAsOutputLayer(parameters, self.OUTPUT_RASTER, context)

        report(sqrtLayer,outputFilePath)
